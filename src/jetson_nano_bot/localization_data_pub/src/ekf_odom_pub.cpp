...
const double TICKS_PER_REVOLUTION = 4; // For reference purposes.
const double WHEEL_RADIUS = 0.335; // Wheel radius in meters
const double WHEEL_BASE = 0.61; // Center of left tire to center of right tire
const double TICKS_PER_METER = 3000; // Original was 2800
